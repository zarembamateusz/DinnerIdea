...
/**
 * Implements a core logic of a [ShareableState] property that calls callback functions when changed.
 */
abstract class ObservableState<T : Any>(receiver: StateHolder, initialState: T) : ReadWriteProperty<StateHolder, T> {

    private var value by receiver.state(initialState)
    ...
    override fun getValue(thisRef: StateHolder, property: KProperty<*>): T = value
